...
namespace YourTable
{
    public partial class Calender : Form
    {
        ...
        void GetDays()
        {
            ...
            for(int i = counter; i <= 31; i++) //Set the days that aren't in the current month to false (unvisable) (idk how to type unvisabe)
            {
        ...
        private void days_Click_Handler(object sender, EventArgs e)
        {
